...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-[85vh] items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-[#04111f]">
      <div className="relative w-full max-w-lg overflow-hidden rounded-4xl border border-white/10 bg-slate-950/80 p-8 shadow-[0_40px_120px_-48px_rgba(0,0,0,0.5)] backdrop-blur-xl sm:p-10">
